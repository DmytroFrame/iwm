...
use crate::{
    ...
    net::protocol::{
        client::play::update_entity_position_and_rotation::UpdateEntityPositionAndRotation,
        package_output::OutputPackage,
    },
};

pub(crate) fn update_entity_position_and_rotation_handler<'a>(
    ctx: EventContext<'a>,
    ...
    Box::pin(async move {
        ...
        main_session
            .stream
            .output
            .send(OutputPackage::UpdateEntityPositionAndRotation(
                UpdateEntityPositionAndRotation::from_session(&second_session),
            ))
            .await
            .unwrap();
    })
