...
use crate::{
    ...
    net::protocol::{
        client::play::update_entity_rotation::UpdateEntityRotation, package_output::OutputPackage,
    },
};

pub(crate) fn update_entity_rotation_handler<'a>(
    ctx: EventContext<'a>,
    ...
    Box::pin(async move {
        ...
        main_session
            .stream
            .output
            .send(OutputPackage::UpdateEntityRotation(
                UpdateEntityRotation::from_session(&second_session),
            ))
            .await
            .unwrap();
    })
