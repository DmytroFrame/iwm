...
use crate::net::protocol::package_writer::PackageWriter;
use crate::net::protocol::{client, server};

pub fn init_server(_: u16) {
    let listener = TcpListener::bind("127.0.0.1:25567").expect("THIS PORT IS USED");
